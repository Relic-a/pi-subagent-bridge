export const AGENT_PROFILE_NAMES = ["explore", "review", "implement"];
export function isAgentProfileName(value) {
    return (typeof value === "string" &&
        AGENT_PROFILE_NAMES.includes(value));
}
...
export function resolveAgentProfile(name, modelDefaults = {}) {
    if (!name)
        return undefined;
